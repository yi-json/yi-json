...
USER_NAME = os.environ['USER_NAME'] # 'yi-json'
...
if __name__ == '__main__':
    ...
    # If you have deleted repositories you want to include, add them to cache/repository_archive.txt
    # and uncomment/modify the code below
